...
const MOON_PHASES = [
  { key: 'nouvelle_lune', label: 'Nouvelle Lune', intention: "Ce que cette nouvelle lune me donne l'élan de semer : l'intention que je pose pour le cycle qui commence." },
  { key: 'premier_croissant', label: 'Premier Croissant', intention: "Le premier pas que ce croissant naissant m'invite à oser, encore fragile mais déjà réel." },
  { key: 'premier_quartier', label: 'Premier Quartier', intention: "La décision ou l'obstacle que ce premier quartier met devant moi, et la force qu'il me demande de rassembler." },
  { key: 'lune_gibbeuse_croissante', label: 'Lune Gibbeuse Croissante', intention: "Ce qu'il me reste à ajuster avant l'aboutissement que cette lune presque pleine annonce déjà." },
  { key: 'pleine_lune', label: 'Pleine Lune', intention: "Ce que cette pleine lune met en pleine lumière dans ma vie, ce qu'elle m'invite à voir enfin clairement, à relâcher ou à célébrer." },
  { key: 'lune_gibbeuse_decroissante', label: 'Lune Gibbeuse Décroissante', intention: "Ce que je commence à comprendre de ce que la pleine lune a révélé, une fois la première émotion retombée." },
  { key: 'dernier_quartier', label: 'Dernier Quartier', intention: "Ce que ce dernier quartier me demande de lâcher, de trancher ou de terminer avant de pouvoir avancer." },
  { key: 'dernier_croissant', label: 'Dernier Croissant', intention: "Ce que ce croissant finissant m'invite à déposer avant que le cycle ne recommence." },
];
...
const ECLIPSE_INTENTIONS = {
  eclipse_solaire: "Le tournant que cette éclipse annonce dans ma vie : ce qui se termine, ce qui commence, la bascule à laquelle je dois me préparer.",
  eclipse_lunaire: "Ce que cette éclipse lunaire révèle de caché en moi : l'émotion ou la vérité qui demande à être reconnue avant de pouvoir avancer.",
};
